...
<form method="POST" use:enhance action="?/request" class="space-y-2">
      ...
      <div class="flex-1">
        <Form.Field {form} name="availability[{i}].date" class="flex flex-col">
          <Form.Control let:attrs>
            ...
            <input
              hidden
              value={$formData.availability[i].date}
              name={attrs.name} />
          </Form.Control>
        </Form.Field>
      </div>
          ...
          <Form.Field
            ...
            <Form.Control let:attrs>
              ...
              <Input
                ...
                min={0}
                max={23}
                bind:value={$formData.availability[i].start.hour} />
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
          ...
          <Form.Field
            ...
            <Form.Control let:attrs>
              ...
              <Input
                {...attrs}
                type="number"
                bind:value={$formData.availability[i].start.minute} />
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
          <Form.Field
            ...
            <Form.Control let:attrs>
              ...
              <Input
                {...attrs}
                type="number"
                bind:value={$formData.availability[i].end.hour} />
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
          <p class="mt-6 text-lg font-semibold">:</p>
          <Form.Field
            ...
            <Form.Control let:attrs>
              ...
              <Input
                {...attrs}
                type="number"
                bind:value={$formData.availability[i].end.minute} />
            </Form.Control>
            <Form.FieldErrors />
          </Form.Field>
          <Button
            on:click={() => {
              $formData.availability.splice(i, 1);
              $formData.availability = $formData.availability;
            }}
            variant="ghost"
            class="ml-2 mt-5">
  ...
  <Form.Field {form} name="notes">
    ...
    <Form.Description>
      Any additional information you would want your mentor to know.
    </Form.Description>
    <Form.FieldErrors />
  </Form.Field>
