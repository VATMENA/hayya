...
<Form.Root method="POST" form={data.form} schema={formSchema} {options} let:config>
  <Form.Item>
  ...
  <Form.Item>
    <Form.Field {config} name="color">
      ...
      <Form.Input />
      <Form.Validation />
      <Form.Description>A <a class="underline-offset-4 underline" href="https://tailwindcss.com/docs/customizing-colors">Tailwind color</a>, e.g. sky-500</Form.Description>
    </Form.Field>
  </Form.Item>
