...
<Drawer.Root>
  ...
  <Drawer.Portal>
    ...
    <Drawer.Content
      ...
      <div
        class="max-h-[96%] flex-1 overflow-y-auto rounded-t-[10px] bg-card p-4">
        <div
          class="mx-auto mb-8 h-1.5 w-12 flex-shrink-0 rounded-full bg-primary/20" />
        <div class="mx-auto max-w-md">
          <Drawer.Title class="sr-only mb-4 font-medium">
            Navigation
          </Drawer.Title>
          <nav>
